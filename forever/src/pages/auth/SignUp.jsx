...
const SignUp = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center p-4">
      <div className="flex flex-col md:flex-row w-full max-w-7xl min-h-[80vh] bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="flex-1 p-8 flex flex-col justify-center">
          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl text-center sm:text-left font-bold text-gray-900 mb-2">
              Create an Account
            </h1>
